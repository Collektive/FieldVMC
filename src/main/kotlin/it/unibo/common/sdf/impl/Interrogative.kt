 ...
 */
class Interrogative(center: Pair<Double, Double>, radius: Double, private val thickness: Double = 0.0) : SDF {
    private val arc =
        Arc(
            center,
            radius,
    ...
    override fun invoke(p: Pair<Double, Double>): Double = min(arc(p), segment(p)) - thickness
}
